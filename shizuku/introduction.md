...
Shizuku can help normal apps uses system APIs directly with adb/root padb shell sh /storage/emulated/0/Android/data/moe.shizuku.privileged.api/start.shri
vileges with a Java process started with app_process.
